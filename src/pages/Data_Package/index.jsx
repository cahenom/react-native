...
export default function DataPackage({navigation}) {
  const isDarkMode = useColorScheme() === 'dark';
  const [providers, setProviders, isLoadingFromHook, , isCacheExpired, needsBackgroundRefresh, isRefreshing] = usePersistentState('data_providers', []);
  ...
  const fetchProviders = async (forceRefresh = false) => {
    ...
    const result = await fetchProviderList('data_providers', '/api/product/data', 'data', forceRefresh);
