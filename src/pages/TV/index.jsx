...
export default function TV({navigation}) {
  ...
  const [providers, setProviders, isLoadingFromHook, , isCacheExpired, needsBackgroundRefresh, isRefreshing] = usePersistentState('tv_providers', []);
  ...
  const fetchProviders = async (forceRefresh = false) => {
    ...
    const result = await fetchProviderList('tv_providers', '/api/product/tv', 'tv', forceRefresh);
  ...
  return (
    <SafeAreaView
      ...
      <CustomHeader title="TV Berlangganan" />
