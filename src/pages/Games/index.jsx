...
export default function Games({navigation}) {
  ...
  const [providers, setProviders, isLoadingFromHook, , isCacheExpired, needsBackgroundRefresh, isRefreshing] = usePersistentState('games_providers', []);
  ...
  const fetchProviders = async (forceRefresh = false) => {
    ...
    const result = await fetchProviderList('games_providers', '/api/product/games', 'games', forceRefresh);
  ...
  const handleProviderPress = (provider) => {
    navigation.navigate('TopupGames', {
      provider: provider,
      title: `${provider} Game`,
    });
  };
  ...
  return (
    <SafeAreaView
      ...
      <CustomHeader title="Topup Games" />
